 ...
 *
 * @author Slava Pestov
 * @version $Id: JEditTextArea.java,v 1.4 2004/02/26 20:48:54 pmarrone Exp $
 */
public class JEditTextArea extends JComponent
{
     ...
     * Logger
     * */
    private static final ILogger log = LoggerFactory.getLogger (JEditTextArea.class);
	...
	public String getText()
	{
		...
		{
			log.warn ( "BadLocationException was thrown. Message is : " + ble.getMessage (),
                       ble );
			return null;
		}
	}
	...
	public void select(int start, int end)
	{
		...
		{
            String msg = "Bounds out of range: " + newStart + "," +	newEnd;
            log.error ( msg );
		...
		if(rectSelect)
		{
			...
			for(int i = selectionStartLine; i <= selectionEndLine; i++)
			{
				...
				if(i != selectionEndLine)
					buf.append ( System.getProperty (EOL) );
			}
	...
	public void setSelectedText(String selectedText)
	{
		...
		{
            String msg;
			log.error ( msg = "Cannot replace selection. Message is : " + ble.getMessage(),
                        ble);
            // TO DO 
            // See if a Joon specific Exception is not more appropriate
            // 
	...
	public void overwriteSetSelectedText(String str)
	{
		...
		{
            log.warn ( "BadLocationException thrown. Message is : " + ble.getMessage (),
                       ble );
	...
	protected void updateBracketHighlight(int newCaretPosition)
	{
		...
		{
            String msg;
            log.error ( msg = "BadLocationException thrown. Message is : " + ble.getMessage(),
                        ble);
		}
