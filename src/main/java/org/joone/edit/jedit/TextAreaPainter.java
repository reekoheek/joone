 ...
 * lines of text.
 * @author Slava Pestov
 * @version $Id: TextAreaPainter.java,v 1.4 2004/02/26 20:48:54 pmarrone Exp $
 */
public class TextAreaPainter extends JComponent implements TabExpander
{
     ...
     * Logger
     * */    
    private static final ILogger log = LoggerFactory.getLogger (TextAreaPainter.class);
	...
	public void setFont(Font font)
	{
        ...
        fm = javax.swing.text.StyleContext.getDefaultStyleContext ().getFontMetrics(font);
	...
	public void paint(Graphics gfx)
	{
		...
		{
			log.error ("Error repainting line range {" + firstInvalid + "," + lastInvalid + "}:");
		}
	}
