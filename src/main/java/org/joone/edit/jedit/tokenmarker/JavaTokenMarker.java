 ...
 *
 * @author Slava Pestov
 * @version $Id: JavaTokenMarker.java,v 1.3 2003/05/29 21:02:46 pmarrone Exp $
 */
	...
	public static KeywordMap getKeywords()
	{
		if(javaKeywords == null)
		{
			...
			javaKeywords.add("false",Token.LITERAL2);
                        // Added for Joone's internal objects
			javaKeywords.add("jNet",Token.KEYWORD1);
			javaKeywords.add("jMon",Token.KEYWORD1);
		}
		return javaKeywords;
	}
