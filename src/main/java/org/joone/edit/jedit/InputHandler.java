 ...
 * 
 * @author Slava Pestov
 * @version $Id: InputHandler.java,v 1.5 2004/10/06 07:47:55 boriskanazawa Exp $
...
public abstract class InputHandler extends KeyAdapter
{
     ...
     * Logger
     * */
    public static final ILogger log = LoggerFactory.getLogger (InputHandler.class);
	...
	public static class backspace implements ActionListener
	{
		public void actionPerformed(ActionEvent evt)
		{
			...
			else
			{
				...
				{
					log.warn ("BadLocationException thrown. Message is " + bl.getMessage ());
				}
			}
		}
	}
	...
	public static class backspace_word implements ActionListener
	{
		public void actionPerformed(ActionEvent evt)
		{
			...
			{
				log.warn ("BadLocationException thrown. Message is : " + bl );
			}
		}
	}
