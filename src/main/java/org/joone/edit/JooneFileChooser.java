...
public class JooneFileChooser extends JFileChooser {
    ...
    public JooneFileChooser(String baseDir) {
        ...
        // look for the history file that is saved from last session.
        m_dir = System.getProperty("user.home")
        + System.getProperty("file.separator") + APPLICATION_NAME
    ...
    private void addDirectory(File p_file) {
        ...
        int posDirSep = absolutePath.lastIndexOf(
    ...
    private class TextPreviewer extends JComponent {
        ...
        private String readFile(File p_file) {
            ...
            try {
                ...
                log.warn( "File '" + p_file + "' not found.",
                fnfe);
                // TO DO
                //    Does this really "return" smthg else than null ?
                return str;
            }
            try {
                ...
                log.warn( "File '" + m_dir + "' input/output error.",
                ioe);
            }
            return str;
        }
