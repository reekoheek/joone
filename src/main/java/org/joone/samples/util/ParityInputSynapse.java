...
/**
 * <p>
 * This synapse creates input and desired output data for the parity problem.
 * The parity problem is the problem where numbers (in binary form) having an
 * even number of ones should output a zero and numbers having an odd number of
 * ones should output a one.
 * <p>
 * The partity problem is a problem that is often used to test new learning
 ...
 * <p>
 * The default size of the parity problem is two, that is, it creates the
...
public class ParityInputSynapse extends StreamInputSynapse {
	...
	private static final ILogger log = LoggerFactory
			.getLogger(ParityInputSynapse.class);

	/**
	 * The size of the parity problem, that is, the number of bits for the input
	 * data. The default is 2, which is just the XOR problem.
	 */
	...
	/**
	 * Sets the number of bits the parity problem should consist of, that is,
	 * the number of bits the input should consist of. For example, a size 2, is
	 * the XOR problem.
	 * 
	 * @param aSize
	 *            the size / number of bits for the input.
	 */
	 ...
	 * 
	 * @return the number of patterns that exist for the parity problem based on
	 *         the parity size.
	 */
	...
	/**
	 * Creates an array holding the input and desired output values for the
	 * parity problem.
	 * 
	...
	protected double[][] createParityArray() {
		...
		/*
		 * debug for(int i = 0; i < myParityInstance.length; i++) { String
		 * myText = ""; for(int j = 0; j < myParityInstance[i].length; j++) {
		 * myText += myParityInstance[i][j] + " "; } log.debug(myText); } // end
		 * debug
		 */
	 ...
	 * 
	 * @param aValue
	 *            the value to use for the upper bit.
	 */
	 ...
	 * 
	 * @param aValue
	 *            the value to use for the lower bit.
	 */
